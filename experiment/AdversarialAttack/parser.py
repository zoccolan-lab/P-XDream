...
def get_parser(multirun: bool = False) -> ArgumentParser:
    '''
    Return the argument parser for AdversarialAttack experiment.
    ...
    parser.add_argument('--metric',         type=def_type(str),   help='Name of the scoring metric used by the scipy.pdist algorithm')
    parser.add_argument('--signature',      type=def_type(str),   help='Description of the layer -> weight mapping defining the scoring behavior')
